...
\begin{longtable}{V}
  \hide{2025     & {Andy Hill CARE Fund, Implementation and Outcomes Research Cycle 2,
  IOR2\_21 (Federation/Pino), Role: Co-Investigator}
             \newline \textit{\$1,499,701 requested}. Not awarded. Submitted for
             ``Targeting the undruggable: structure-free discovery of small-molecule
             modulators for oncogenic transcription factors via native-context
             functional proteomics and AI'' \\}
  \hide{2025     & {NIH/NHGRI, 1R43HG014987-01 (Pino), Role: Principal Investigator}
             \newline Reviewed, not funded. Submitted for ``Scaling TF-Scan to build a
             human tissue atlas of genome and epigenome regulators'' \\}
  \hide{2025     & {NIH/NHGRI, 1R43HG014443-01A1 (Pino), Role: Principal Investigator}
             \newline \textit{\$313,671 requested}. Reviewed, not funded. Resubmission,
             ``Scaling TF-Scan to build a human tissue atlas of genome and epigenome
             regulators'' \\}
  \hide{2024     & {NIH/NHGRI, 1R43HG014443-01 (Pino), Role: Principal Investigator}
             \newline \textit{\$306,150 requested}. Reviewed, not funded. Submitted for
             ``Scaling TF-Scan to build a human tissue atlas of genome and epigenome
             regulators'' \\}
  \hide{2024     & {NIH/NIA, 1R43AG094414-01 (Pino), Role: Principal Investigator}
             \newline \textit{\$303,940 requested}. Reviewed, not discussed. Submitted for
             ``Network-targeted causal inference for TF proteomics: enhancing the TF-Scan
             platform for anti-aging drug discovery'' \\}
  ...
  \hide{2023     & {NIH/NIA, 1R43AG084786-01 (Pino), Role: Principal Investigator}
             \newline \textit{\$273,756 requested}. Administratively withdrawn. Submitted
             for ``Rejuvenation of defective immune function in aged lymphocytes with
  ...
  \hide{2021     & {NIH/NIA, 1R44AG078710-01 (Pino), Role: Principal Investigator}
             \newline \textit{\$1,985,277 requested}. Administratively withdrawn. Submitted
             for ``Rejuvenation of aged-donor T cells through epigenetic therapeutics'' \\}
  ...
  \hide{2020     & {NIH/NIA, 1F32AG072823-01 (Pino), Role: Principal Investigator}
             \newline Administratively withdrawn. Submitted for ``Characterization of STING
             structure and function in cellular senescence'', University of Pennsylvania \\}
  \hide{2019     & {NIH/NIA, 1F32AG066456-01A1 (Pino), Role: Principal Investigator}
             \newline Administratively withdrawn. Resubmission, ``Characterization of STING
             structure and function in cellular senescence'', University of Pennsylvania \\}
  \hide{2019     & {NIH/NIA, 1F32AG066456-01 (Pino), Role: Principal Investigator}
             \newline Administratively withdrawn. Submitted for ``Characterization of STING
             structure and function in cellular senescence'', University of Pennsylvania \\}
  \hide{2015     & {NIH/NIGMS, 1F31GM119226-01 (Pino), Role: Principal Investigator}
             \newline Administratively withdrawn. Submitted for ``Investigation and modeling
             of yeast proteome response to transcription factor deletion'', University of
             Washington \\}
...
% Pulled from the Google Patents inventor index and cross-checked entry by entry
% against Espacenet (titles, inventor order, applicants, application and priority
% numbers, family members). Nothing here is granted yet, so every row is an
% application. Talus counsel or the IP docket is still the authority on anything
% unpublished -- an in-flight provisional or a national phase not yet laid open
% would not show up in either index.
\hide{\mysection{Patents}
\begin{longtable}{V}
  2023 & {\bf Lectin-assisted isolation of mammalian cell nuclei}
         \newline Robbins JE, Canzani D, Broderick EF, Schumacker NC, {\bf Pino LK}, Federation AJ
         \newline Assignee: Talus Bioscience, Inc.
         \newline PCT/US2024/014339, WO 2024/163960 (Aug 2024); EP 24751159.5, EP 4658665 A2 (Dec 2025)
         \newline Priority: US provisional 63/443,201, 3 Feb 2023. \textit{Pending}\\
  2023 & {\bf Extraction of nuclear and chromatin-bound proteins using volatile salts}
         \newline Canzani D, Gutierrez AI, {\bf Pino LK}, Federation AJ
         \newline Assignee: Talus Bioscience, Inc.
         \newline PCT/US2024/014337, WO 2024/163959 (Aug 2024); US 19/152,833, US 2026/0226097 A1 (Aug 2026)
         \newline Priority: US provisional 63/443,216, 3 Feb 2023. \textit{Pending}\\
  2022 & {\bf Methods for identifying reactive functional cysteines in nuclear proteins}
         \newline Canzani D, Fondrie WE, {\bf Pino LK}, Federation A
         \newline Assignee: Talus Bioscience, Inc.
         \newline PCT/US2023/067134, WO 2023/225568 A1 (Nov 2023); US 18/865,559, US 2025/0306032 A1 (Oct 2025)
         \newline National phase also in EP 4526686 A1, AU 2023272100 A1, CA 3256890 A1
         \newline Priority: US provisional 63/342,908, 17 May 2022. \textit{Pending}\\
\end{longtable}}
...
\begin{etaremune}
    ...
    \item Moderator, ``The AI Toolkit for Life Sciences''. (Sep 2026) \textit{Life Science Washington}, Seattle, WA.
...
% Description(s) of tasks/responsibilities
  ...
  2020--22 & Early Career Research Group, US Human Proteome Organization (US HUPO). \textit{Founding member}. \\
% Description(s) of tasks/responsibilities
